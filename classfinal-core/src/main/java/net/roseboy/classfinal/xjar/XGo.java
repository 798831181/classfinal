package net.roseboy.classfinal.xjar;
...
import net.roseboy.classfinal.xjar.key.*;
...
public class XGo {
    ...
    public static void main(String[] args) {
        byte[] passwd = {123, 52, 56, 44, 32, 52, 56, 44, 32, 52, 56, 44, 32, 52, 56, 44, 32, 52, 56, 44, 32, 52, 56, 125};
        String key = "000000";
        System.out.println(new String(passwd));
        byte[] nkey = {48, 48, 48, 48, 48, 48};
        System.out.println(new String(nkey));
    }
